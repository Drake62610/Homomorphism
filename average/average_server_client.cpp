...
cout << "Please enter the weights (q to end):\n";
double myweight;
for (int i = 0; i < rational_numbers.size(); i++) {
  std::cout << "Weight of :" << rational_numbers[i] << endl;
  cin >> myweight;
  coefficients.push_back(myweight);
}
cout << "vector of weights : ";
...
//Encryption du vecteur
  ...
  cout << "Encryption of weights ...... DONE" << endl;
  cout << endl;
