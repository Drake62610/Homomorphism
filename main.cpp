...
void test_plusPetit(Evaluator evaluator, Decryptor decryptor,Encryptor encryptor){
  cout << "test plus petit 1 bit" << endl;
  Plaintext myPlaintext1("1");Plaintext myPlaintext0("0");
  Plaintext plainResult("0");
  Ciphertext myCipher1; encryptor.encrypt(myPlaintext1,myCipher1);
  Ciphertext myCipher0; encryptor.encrypt(myPlaintext0,myCipher0);
  ...
  //TESTS
  CipherBit result = strictPlusPetit(myCipherBit0,myCipherBit1);
...
int main(){
  ...
  test_plusPetit(evaluator,decryptor,encryptor);
