...
/*
	Input : Deux entiers en clair
	Output : Le PGCD des deux en utilisant la méthode d'Euclide
*/
...
/*
	...
	Cette fonction est obsolète aujourd'hui
*/
...
/*
	Le main comporte un exemple pour le paramètrage
	de deux entier et comment les passer dans le domaine homomorphique
*/
int main(){
	//###Parametrage####
